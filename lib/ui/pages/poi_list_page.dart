...
import 'package:pathfinder/ui/pages/edit_poi_page.dart';
...
class _PoiListState extends State<PoiListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _addNewPoiFab(context),
    );
  }

  Widget _addNewPoiFab(BuildContext context) {
    PoiListBloc bloc = BlocProvider.of<PoiListBloc>(context);
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => BlocProvider(
                create: (_) => EditPoiBloc(PoiDataState()),
                child: EditPoiPage(
                  onPoiSaved: (poi) => bloc.add(PoiListEvent(PoiListEventType.add, poi: poi)),
                ),
              ),
            ));
      },
